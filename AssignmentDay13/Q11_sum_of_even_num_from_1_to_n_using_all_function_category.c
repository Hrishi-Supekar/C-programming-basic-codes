...
//	scanf("%d",&n);
//	ans=sum_1_to_n(n);
//	printf("The addition all even num from 1 to n is:%d",ans);	
//	return 0;
//}
...
//		s=s+i;
//	}
//	printf("The addition all even num from 1 to n is:%d",s);	
//}
//=======================================================================================================
...
void sum_1_to_n()
{
	...
	printf("The addition all even number from 1 to n is:%d",s);	
}
